...
Shader::Shader(const char* vertexSource, const char* fragmentSource, const char* shaderName) {
	...
	if (vertexFile.is_open()) {
		...
		logError("Error: Cannot read ", shaderName, " vertex shader file!", vertexSource);
	}
	...
	if (fragmentFile.is_open()) {
		...
		logError("Error: Cannot read ", shaderName, " fragment shader file! ", fragmentSource);
	}
