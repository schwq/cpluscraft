...
class Shapes {
public:
    Shapes(glm::vec3 initialPos, Texture& tex, bool isNull = false, bool hasSpecularTex = true, float specularFator = 0.5) : specularFator(specularFator), hasSpecularTex(hasSpecularTex), tex(tex), isNull(isNull) {} 
    ~Shapes() {
...
public:
    ...
    Cube(glm::vec3 initialPos, Texture& tex, bool isNull = false);
